...
function validateForm(form) {
  ...
  if (!form.birthdate) {
    ...
    const min = new Date('2015-01-01T00:00:00');
    if (selected > today) errors.birthdate = 'Birthdate cannot be in the future.';
    else if (selected < min) errors.birthdate = 'Please enter a valid student birthdate.';
  }
